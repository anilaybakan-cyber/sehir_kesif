...
desktop_path = os.path.expanduser("~/Desktop/sehir_kesif_yerler.xlsx")
        ...
        try:
            ...
            for highlight in data.get('highlights', []):
                ...
                row = [
                    ...
                    city_en,
                    highlight.get('name', ''),
                    highlight.get('name_en', highlight.get('name', '')),
                    category_tr,
                    category_en,
                    highlight.get('description', ''),
                    highlight.get('description_en', ''),
                    highlight.get('tips', ''),
                    highlight.get('tips_en', ''),
                    tags_tr,
                    highlight.get('area', '')
                ]
                sheet.append(row)
...
print(f"Excel file created successfully at: {desktop_path}")
