...
def normalize_name(name):
    ...
    name = name.replace('vieux-port', 'old port').replace('limanı', '').replace('liman', '')
    name = name.replace('abbaye ', '').replace('manastırı', '').replace('manastır', '')
    name = name.replace('cathédrale ', '').replace('katedrali', '').replace('katedral', '')
    name = name.replace('plage ', '').replace('plajı', '').replace('plaj', '')
    name = name.replace('parc ', '').replace('parkı', '').replace('park', '')
    name = name.replace('fort ', '').replace('kalesi', '').replace('kale', '')
    return name.strip()

def cleanup_marseille():
...
count = cleanup_marseille()
print(f"Marseille cleaned. Final unique count: {count}")
