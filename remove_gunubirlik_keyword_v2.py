    ...
    try:
        ...
        if 'highlights' in data:
            for place in data['highlights']:
                # String fields
                for field in ['name', 'name_en', 'description', 'description_en', 'area', 'area_en', 'tips', 'tips_en', 'subcategory']:
                ...
                if 'tags' in place and isinstance(place['tags'], list):
                    original_tags = place['tags']
                    new_tags = [clean_text(tag) for tag in original_tags if clean_text(tag)]
