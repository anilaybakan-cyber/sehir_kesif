...
CITY_FILE = "assets/cities/kotor.json"
MIN_DESCRIPTION_LENGTH = 80  # Characters
TARGET_DESCRIPTION_LENGTH = 200  # Target ~200 chars
MAX_BATCH_SIZE = 50

def generate_rich_description(place_name, name_en, category, tags, current_desc, city_name="Kotor"):
...
ÖRNEK ÇIKTI:
"Kotor'un kalbinde yer alan bu tarihi yapı, Venedik mimarisinin en güzel örneklerinden biridir. 17. yüzyıldan kalma bu saray, bugün denizcilik tarihine ışık tutan zengin bir müzeye ev sahipliği yapmaktadır."
