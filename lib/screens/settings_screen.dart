...
import '../services/premium_service.dart'; // Added
import '../l10n/app_localizations.dart';
import '../theme/wanderlust_colors.dart'; // Added for accent color consistency if needed
          ...
          : ListView(
              ...
              children: [
                ...
                _buildActionTile(
                  ...
                  iconColor: const Color(0xFF6C5CE7), 
                  title: "Terms of Use (EULA)", // Localize?
                  onTap: () => _launchURL('https://www.apple.com/legal/internet-services/itunes/dev/stdeula/'),
                ),
                _buildActionTile(
                  icon: Icons.restore_rounded, 
                  iconColor: const Color(0xFF00B894), 
                  title: AppLocalizations.instance.isEnglish ? "Restore Purchases" : "Satın Alımları Geri Yükle",
                  onTap: _restorePurchases,
                ),
                _buildActionTile(
                  icon: Icons.subscriptions_outlined, 
                  iconColor: const Color(0xFF0984E3), 
                  title: AppLocalizations.instance.isEnglish ? "Manage Subscription" : "Aboneliği Yönet",
                  onTap: () => _launchURL('https://apps.apple.com/account/subscriptions'),
                ),
