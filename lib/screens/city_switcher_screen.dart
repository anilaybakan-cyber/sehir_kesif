...
class _CitySwitcherModalState extends State<_CitySwitcherModal> {
  ...
  // Alphabetical sort based on current language
  ...
  void initState() {
    ...
    // 1. Initialize and sort cities based on language
    final isEnglish = AppLocalizations.instance.isEnglish;
    
    _cities = List.from(CitySwitcherScreen.allCities);
    _cities.sort((a, b) {
    ...
    // 2. Add "Undecided" option at the top
    _cities.insert(0, {
      "id": "undecided",
      "name": "undecided_label", 
      "name_en": "undecided_label", // Ensure compatibility
      "country": "MyWay",
      "country_en": "MyWay",
      "flag": "🌍",
  ...
  Widget build(BuildContext context) {
    ...
    // Fixed height: 85% of screen height
    return Container(
            ...
            child: Builder(
              builder: (context) {
                ...
                final filteredCities = _cities.where((city) {
                  ...
                  // Get localized name and country
