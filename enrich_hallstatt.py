...
CITY_FILE = "assets/cities/hallstatt.json"
MIN_DESCRIPTION_LENGTH = 80  # Characters
TARGET_DESCRIPTION_LENGTH = 200  # Target ~200 chars
MAX_BATCH_SIZE = 50

def generate_rich_description(place_name, name_en, category, tags, current_desc, city_name="Hallstatt"):
...
ÖRNEK ÇIKTI:
"Köyün ve gölün kuşbakışı manzarasını sunan bu nokta, fotoğraf tutkunları için vazgeçilmezdir. UNESCO Dünya Mirası manzarasını izlerken büyüleyici bir atmosferin parçası hissedeceksiniz."
